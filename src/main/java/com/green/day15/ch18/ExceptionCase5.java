...
public class ExceptionCase5 {
    public static void main(String[] args){
        ...
        try {
            ...
            int n2 = scan.nextInt();
            System.out.printf("%d/%d=%d\n",n1,n2,n1/n2);        //만약 system.out.printf가 try-catch문 바깥에 있다면 어떨까?
            ...
            //Exception은 모든 예외처리를 다 잡기 때문에 catch문의 가장 아래에 작성하도록 한다. if문의 else와 같은 역할을 한다.
            e.printStackTrace();
            System.out.println(e.getMessage());
        }
        ...
        try {
            ...
            e.printStackTrace();
            System.out.println(e.getMessage());
        }catch(Exception e){   //보통은 exception마다 다른 처리를 하도록 한다.
            e.printStackTrace();
            System.out.println(e.getMessage());
        }
        Hypen.line();
