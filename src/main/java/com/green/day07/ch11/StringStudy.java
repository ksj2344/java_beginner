...
public class StringStudy {
    public static void main(String[] args) {
        ...
        String str3 = str1.concat(str2);  //concat 문자열을 합치는 메소드
        ...
        System.out.println(str7.compareTo(str8)); // 문자열 안같음
        ...
        String str10 = String.valueOf(n); //실수, boolean.. 모든 타입을 String으로 변경할 수 있다.
